...
public class WidgetContentManager {
    ...
    public static void updateAllViews(final Context context, final RemoteViews views, final int appWidgetId) {
        ...
        new DataManager.GetDeviceStatusTask(context, new OnProcessFinish<ReturnObject>() {
            ...
            public void onSuccess(ReturnObject result) {
				...
				fillViews(result, context, views, appWidgetId);
				...
				long difference = new Date().getTime() - startingTime.getTime();
				Log.d(TAG, "Tasks DONE: Took "+difference+" milliseconds!");
            }
	 ...
	 */
    private static void fillViews(ReturnObject data, Context context, RemoteViews views, int appWidgetId) {
